...
import IsaacLab_Terrains.tasks.manager_based.locomotion.velocity.mdp as mdp
...
from IsaacLab_Terrains.tasks.manager_based.locomotion.velocity.mdp.myTerrainCfg import MY_TERRAIN_CFG
