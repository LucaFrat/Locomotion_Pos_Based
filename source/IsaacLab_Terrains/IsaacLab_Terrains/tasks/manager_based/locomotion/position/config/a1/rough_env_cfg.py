...
from IsaacLab_Terrains.tasks.manager_based.locomotion.position.position_env_cfg import LocomotionPositionRoughEnvCfg
...
@configclass
class UnitreeA1RoughEnvCfg(LocomotionPositionRoughEnvCfg):
