...
import tasks.manager_based.locomotion.position.config.spot.mdp as spot_mdp
import tasks.manager_based.locomotion.position.mdp as mdp
from IsaacLab_Terrains.tasks.manager_based.locomotion.position.position_env_cfg import LocomotionPositionRoughEnvCf
...
@configclass
class SpotFlatEnvCfg(LocomotionPositionRoughEnvCf):
