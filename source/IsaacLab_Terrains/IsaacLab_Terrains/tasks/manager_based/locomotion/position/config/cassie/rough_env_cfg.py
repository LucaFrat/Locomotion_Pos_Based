...
from IsaacLab_Terrains.tasks.manager_based.locomotion.position.position_env_cfg import LocomotionPositionRoughEnvCf, RewardsCfg
...
@configclass
class CassieRoughEnvCfg(LocomotionPositionRoughEnvCf):
